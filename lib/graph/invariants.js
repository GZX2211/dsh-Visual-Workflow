...
import { ruleCannotReachEnd, ruleConditionPair, ruleEndFlowIn, ruleEndRequired, ruleFlowCycle, ruleOrphanNode, ruleReachability, ruleStageDirection, ruleStartFlowOut, ruleStartRequired, } from './invariants-rules.js';
import { ruleCtxSource, ruleDataNodeComplete, ruleDbTarget, ruleGroupMembers, ruleMilestoneProxy, ruleProxySource, } from './invariants-rules-nodes.js';
import { ruleDuplicateRoleLabel, ruleMetaLimits, ruleNamingConvention } from './invariants-meta-rules.js';
import { GRAPH_INVARIANT_CODES } from './invariants-types.js';
...
export function isRegisteredCode(code) {
