...
import { META_BELOW_MIN_CODE, META_LIMIT_EXCEEDED_CODE } from './invariants-types.js';
 ...
 */
export function metaLimitIssues(meta, usage) {
    const issues = [];
...
//# sourceMappingURL=org-meta-limits.js.map