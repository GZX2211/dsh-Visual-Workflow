window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function FlowNode({ node, copy, mode, selected, highlighted, dragging, runStatus, locked, lockHint, onPointerDown, onHandlePointerDown, onToggleSwap }) {
			const kind = node.kind;
