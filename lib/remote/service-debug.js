...
async function upstreamErrorText(response) {
    try {
 ...
 */
export async function openServiceDebug(target, prompt, fetchImpl = fetch, signal) {
    let response;
    try {
 ...
 */
export async function pumpServiceDebug(body, sink, signal) {
    try {
...
export async function streamServiceDebug(target, prompt, sink, fetchImpl = fetch, signal) {
    const body = await openServiceDebug(target, prompt, fetchImpl, signal);
    await pumpServiceDebug(body, sink, signal);
}
//# sourceMappingURL=service-debug.js.map