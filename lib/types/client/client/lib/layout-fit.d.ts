 ...
 */
export declare function needsAutoLayout(nodes: LayoutBoxNode[] | null | undefined): boolean;
 ...
 */
export declare function tidyNodes<T extends LayoutBoxNode>(nodes: T[], lines: Array<{
    source: string;
    target: string;
    sourceHandle?: string;
    targetHandle?: string;
