...
// （as const），供 host 半区（host/api/routes.ts、tools/*、orchestrator/*）与 client 半区
// （remote.ts、styles/ 目录、i18n.ts）共用，避免两端字符串漂移。
//
// 约束（见 ./AGENTS.md）：
...
// （架构文档 §4.6）。以下常量即 <endpoint> 段字符串，host api/routes.ts 与
...
// 共用（client styles/tokens.ts 定义变量，画布组件按连线类型引用变量名渲染）。
 ...
 */
export const SCHEDULER_TIMEZONE_SUGGESTIONS: readonly string[] = [
  'Asia/Shanghai',
  'Asia/Hong_Kong',
  'Asia/Tokyo',
  'Asia/Singapore',
