// tests/host/orchestrator/runtime-service.test.ts
//
...
//
// 归属说明：断言对象是 OrchestratorRuntime 的服务文档运行路径（服务文档由 storage
// 投影），不涉及 service 模块的生命周期/端口/HTTP 适配——故归 orchestrator 测试目录。
