...
// tests/client/lib/graph-model.test.ts
//
...
// ---------------------------------------------------------------------------
// serializeFlow：P3 虚拟节点 data 回归
// （原 tests/client/serialize-workflow.test.ts 中由 lib/graph-model.serializeFlow 承担的用例，
//   结构治理后按源文件归属并入本文件；serializeWorkflow 用例归 hooks/useWorkflows.test.tsx）
// ---------------------------------------------------------------------------
